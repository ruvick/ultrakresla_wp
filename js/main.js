...
$(document).ready(function () {
	...
	$('img[data-slide]').click(function (e) {
		...
		$('.galary-sl-small').slick('slickGoTo', slideno - 0);
	});
	...
	// 	if ($('.popup-' + pl).find('.galary-sl-big').length > 0) {
	// 		$('.popup-' + pl).find('.galary-sl-big').slick('setPosition');
	// 	}
	// }
